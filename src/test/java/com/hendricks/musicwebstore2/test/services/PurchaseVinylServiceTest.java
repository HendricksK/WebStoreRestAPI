 ...
 * @author kurvin
 */
public class PurchaseVinylServiceTest {
    
    private static ApplicationContext ctx;
    private ProductPurchaseRepository repo;
    private PurchaseVinylService service;
    
    public PurchaseVinylServiceTest() {
    }
    ...
    @Test
     public void purchase() {
         service = ctx.getBean(PurchaseVinylService.class);
