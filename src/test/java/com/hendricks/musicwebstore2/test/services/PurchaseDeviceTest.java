...
public class PurchaseDeviceTest {
    ...
    private PurchaseDeviceService service;
    ...
    //
     ...
     public void purchaseDevice() {
         service = ctx.getBean(PurchaseDeviceService.class);
         repo = ctx.getBean(ProductPurchaseRepository.class);
         Double price = service.buyDevice("MP3 Player", "c2");
         repo.deleteAll();
         Assert.assertEquals(price, 800.59);
     }
