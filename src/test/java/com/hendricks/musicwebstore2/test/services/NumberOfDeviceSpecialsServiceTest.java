 ...
 * @author kurvin
 */
public class NumberOfDeviceSpecialsServiceTest {
    private static ApplicationContext ctx;
    private NumberOfDeviceSpecialsService service;
    private ProductPurchaseRepository repo;
    
    public NumberOfDeviceSpecialsServiceTest() {
    }
    ...
    //
     @Test
     public void special() {
         service = ctx.getBean(NumberOfDeviceSpecialsService.class);
         repo = ctx.getBean(ProductPurchaseRepository.class);
         int check = service.numberOfSpecials(300.00);
         repo.deleteAll();
