...
import com.hendricks.musicstoreweb2.services.PurchaseDigitalMediaService;
 ...
 * @author kurvin
 */
public class PurchaseDigitalMediaTest {
    private static ApplicationContext ctx;
    private ProductPurchaseRepository repo;
    private PurchaseDigitalMediaService service;
    
    public PurchaseDigitalMediaTest() {
    }
    ...
    @Test
     public void purchase() {
         service = ctx.getBean(PurchaseDigitalMediaService.class);
         repo = ctx.getBean(ProductPurchaseRepository.class);
         Double price = service.buyDevice("Thanks For The Meomories", "c2");
         repo.deleteAll();
         Assert.assertEquals(price, 3.99);
     }
