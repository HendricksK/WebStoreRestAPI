 ...
 * @author kurvin
 */
public class NumberOfDigitalMusicServiceTest {
    private static ApplicationContext ctx;
    private NumberOfDigitalMusicSpecialService service;
    private ProductPurchaseRepository repo;
    
    public NumberOfDigitalMusicServiceTest() {
    }
    ...
    //
     @Test
     public void special() {
         service = ctx.getBean(NumberOfDigitalMusicSpecialService.class);
         repo = ctx.getBean(ProductPurchaseRepository.class);
         int check = service.numberOfSpecials(3.00);
         repo.deleteAll();
